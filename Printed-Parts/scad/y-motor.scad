...
// Pull Prusa's motor mount into a module so it's easier to work with in isolation
module motorMount()
{
// Motor holding part
   translate(v = [29,-21+50,0])
   {
      ...
      //end stop
      // My printer's end-stop is on the opposite end of the motor mount
      if( renderEndstopMount )
      {
...
module y_motor_holes(){
 ...
 //endstop
    ...
    // This cuts through the extended Y motor mount arm
