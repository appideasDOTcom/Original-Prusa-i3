...
module x_end_motor_holes(){
 ...
 translate(v=[-1,32,30.25]){
  ...
  translate(v=[1,-15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 10 + extraBaseDepth, r=3.1, $fn=30);
  translate(v=[20,-15.5,15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=1.8, $fn=30);
  translate(v=[1,-15.5,15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 10 + extraBaseDepth, r=3.1, $fn=30);
   translate(v=[20,15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=1.8, $fn=30);
  translate(v=[1,15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 10 + extraBaseDepth, r=3.1, $fn=30);
  translate(v=[20,15.5,15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=1.8, $fn=30);
  translate(v=[1,15.5,15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 10 + extraBaseDepth, r=3.1, $fn=30); // This is the hole to nowhere
...
module x_end_motor_shaft_cutout(){
    ...
    translate(v=[-40,25.2,-11.8 +30]) rotate(a=[0,90,0]) cylinder(h = 40, r=3, $fn=30);
    translate(v=[-40,19.05,30]) rotate(a=[0,90,0]) cylinder(h = 40, r=3.5, $fn=100);
}
}
...
module extraBase()
{
    translate( [-31.5, 10.5, 0] )
    {
        cube( [extraBaseDepth, 42.5, 53] );
    }
